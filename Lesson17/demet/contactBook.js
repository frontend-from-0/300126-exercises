...
*/
const contacts = [
  { name: "Ali", phone: "111", email: "ali@mail.com" },
  { name: "Ayşe", phone: "222", email: "ayse@mail.com" }
];
...
updateContact("Ali", "999", "newali@mail.com");
/*
-----------------------------------------------------------
...
*/
const contacts = [
  { name: "Demet", phone: "111", email: "demet@mail.com" },
  { name: "İdil", phone: "222", email: "idil@mail.com" }
];
...
*/
console.log("=== CONTACT BOOK TEST START ===");


updateContact("Kerem", "999", "newkerem@mail.com");


removeContact("Fatma");


updateContact("Ahmet", "000", "ahmet@mail.com");
removeContact("Ahmet");
