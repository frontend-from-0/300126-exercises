...
console.log(`Ex.18: Division result is ${divisionQuotient} and subtraction difference is ${subtractionDifference}`);
...
const applicantFirstName = "Murat";
const applicantLastName = "Kanbur";
...
console.log(`Ex.21: Pi number is ${Math.PI}`);
console.log(`Ex.21.1: Pi number is ${Math.PI.toFixed(2)}`);
...
console.log(`Ex.22.1: ${demonstrationCounter}`);
...
console.log(`Ex.24: ${++valueForPrefixIncrement}`); 
...
console.log(`Ex.25: ${valueForPostfixIncrement++}`); 
