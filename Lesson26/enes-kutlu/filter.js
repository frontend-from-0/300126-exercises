...
const wordsWithLetterA = wordsExercise2.filter((word) => word.split('').includes('a'));
console.log(wordsWithLetterA)
...
console.log('Ex.4');
const usersAgeOver25 = usersExercise4.filter((person)=> person.age >= 25);
console.log(usersAgeOver25);
...
console.log('Ex.6');
const availableItems = productsExercise6.filter((items) => items.quantity > 0);
...
const divisibleWithThree = numbersExercise7.filter((num) => num % 3 == 0);
console.log(divisibleWithThree);
...
console.log('Ex.8');
const wordsWithMoreThan5Char = wordsExercise8.filter(word => word.length > 5);
console.log(wordsWithMoreThan5Char)
...
console.log('Ex.10');
const namesWithoutStartsWithLetterJ = usersExercise10.filter((word) => !word.name.split('')[0].toUpperCase().includes('J'))
console.log(namesWithoutStartsWithLetterJ)