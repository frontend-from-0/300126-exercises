...
const sortedByAge = people.sort((person1, person2) => person1.age - person2.age);
...
const sortByLengthOfWords = words.sort((word1, word2) => word1.length - word2.length)
console.log('Ex.5')
console.log(sortByLengthOfWords);