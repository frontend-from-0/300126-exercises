...
console.log("Ex.1:", wordsConvertedUpperCase);
...
const squareNumbers = numbersExercise2.map(
	(number) => number * number 
);

console.log("Ex.2:", squareNumbers);
...
const wordsLengths = wordsExercise4.map(
		(word) => word.length 
);

console.log("Ex.4:", wordsLengths); 
...
const studentsNameAndGrade = studentsExercise5.map(
	(student) => student.name + " " + student.grade
);

console.log("Ex.5:", studentsNameAndGrade); 
...
const numbersToString = numbersExercise6.map(
	(number) => number.toString()
);

console.log("Ex.6:", numbersToString);
...
const splitToWords = sentencesExercise7.map(
	(sentence) => sentence.split(" ")
);
console.log("Ex.7:", splitToWords);
...
const usersEmail = usersExercise8.map(
	(user) => user.email 
);

console.log("Ex.8", usersEmail);
...
const booksTitleAndAuthor = booksExercise9.map(
	(book) => book.title + " / " + book.author
);

console.log("Ex.9", booksTitleAndAuthor)
// Exercise 10:
...
const pricesAddCurrency = pricesExercise10.map(
 (currency) => currency + "£"
);

console.log("Ex.10", pricesAddCurrency);