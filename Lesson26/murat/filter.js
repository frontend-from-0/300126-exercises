...
console.log("Ex.1", oddNums);
console.log("Ex.1", numbersExercise1);
...
const withoutA = wordsExercise2.filter(
	(word) => !word.includes("a")
);

console.log("Ex.2", withoutA);
...
console.log("Ex.3", expensiveBooks);
...
const overTheAgeOf25 = usersExercise4.filter(
	(person) => person.age >= 25 
);

console.log("Ex.4", overTheAgeOf25)
...
console.log("Ex.5", shortSentences);
...
const filterCharacters = wordsExercise8.filter(
	(word) => word.length <= 5
);

console.log("Ex.8", filterCharacters)
...
console.log("Ex.9", passingStudents);
...
const filterName = usersExercise10.filter(
	(person) => !person.name.startsWith("J")
)

console.log("Ex.10",filterName)