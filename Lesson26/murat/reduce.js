...
const maxScore = numbersEx2.reduce(
  (acc, val) => acc > val ? acc : val
)
console.log("Ex.2", maxScore)
...
const avarageTotal = numbersEx4.reduce(
  (acc, val) => acc + val/numbersEx4.length, 0
)
console.log("Ex.4", avarageTotal)
...
console.log("Ex.5", uniqueCount); // Output: 5
